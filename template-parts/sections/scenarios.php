                                ...
                                <div class="scenarios__gallery-marquee" data-scenarios-marquee>
                                    ...
                                    <div class="scenarios__gallery-item">
                                        <div class="scenarios__video-preview">
                                            <video class="scenarios__gallery-img scenarios__video-thumb" muted autoplay loop playsinline disablePictureInPicture controlsList="nofullscreen" preload="auto" src="<?php echo esc_url(screenl_asset('svadba.mp4')); ?>"></video>
                                        </div>
                                    </div>
                                    <div class="scenarios__gallery-item">
