        ...
        <section class="hero">
            <header class="hero__header">
                ...
                <div class="hero__menu" id="menuOpen" role="button" tabindex="0" aria-label="Открыть меню">
                    ...
                    <p class="hero__menu-text">меню</p>
                </div>
            </header>
            <div class="hero__screen-anim" aria-hidden="true">
                <div class="screen-group" id="screenGroup">
                    <div class="panels" id="panels">
                        <div class="panel-mask" data-panel="1"><div class="panel-mask__clip"><img class="panel-mask__img" data-asset="screen" src="<?php echo screenl_asset('hero/screen-panel.png'); ?>" alt=""></div></div>
                        <div class="panel-mask" data-panel="2"><div class="panel-mask__clip"><img class="panel-mask__img" data-asset="screen" src="<?php echo screenl_asset('hero/screen-panel.png'); ?>" alt=""></div></div>
                        <div class="panel-mask" data-panel="3"><div class="panel-mask__clip"><img class="panel-mask__img" data-asset="screen" src="<?php echo screenl_asset('hero/screen-panel.png'); ?>" alt=""></div></div>
                        <div class="panel-mask" data-panel="4"><div class="panel-mask__clip"><img class="panel-mask__img" data-asset="screen" src="<?php echo screenl_asset('hero/screen-panel.png'); ?>" alt=""></div></div>
                        <div class="panel-mask" data-panel="5"><div class="panel-mask__clip"><img class="panel-mask__img" data-asset="screen" src="<?php echo screenl_asset('hero/screen-panel.png'); ?>" alt=""></div></div>
                    </div>
                </div>
            ...
            <div class="hero__product">
                ...
                <div class="hero__features">
                    <div class="hero__feature">
                        ...
                        <p class="hero__feature-text">Один формат для всего</p>
                    </div>
                    <div class="hero__feature">
                        <div class="hero__feature-icon"><div class="hero__feature-arrow"><svg class="hero__feature-arrow-svg" fill="none" preserveAspectRatio="none" viewBox="0 0 24.9008 4.15014"><path d="M22.5336 0.274827L0 0L2.20731 3.61342L24.9008 4.15014L22.5336 0.274827Z" fill="white"></path></svg></div></div>
                        <p class="hero__feature-text">Расписание, навигация и брендинг</p>
                    </div>
                    <div class="hero__feature">
                        <div class="hero__feature-icon"><div class="hero__feature-arrow"><svg class="hero__feature-arrow-svg" fill="none" preserveAspectRatio="none" viewBox="0 0 24.9008 4.15014"><path d="M22.5336 0.274827L0 0L2.20731 3.61342L24.9008 4.15014L22.5336 0.274827Z" fill="white"></path></svg></div></div>
                        <p class="hero__feature-text">Без печати</p>
                    </div>
                    <div class="hero__feature">
                        <div class="hero__feature-icon"><div class="hero__feature-arrow"><svg class="hero__feature-arrow-svg" fill="none" preserveAspectRatio="none" viewBox="0 0 24.9008 4.15014"><path d="M22.5336 0.274827L0 0L2.20731 3.61342L24.9008 4.15014L22.5336 0.274827Z" fill="white"></path></svg></div></div>
                        <p class="hero__feature-text">Без лишней застройки</p>
                    </div>
                </div>
            </div>
            <div class="hero__screen-chrome" id="screenChrome" aria-hidden="true">
                ...
                <div class="shadows" id="shadows">
                    <div class="shadow-group" data-shadow="0"><img class="shadow-group__svg" data-asset="shadowPanels" src="<?php echo screenl_asset('hero/shadow-panels-joined.png'); ?>" alt=""></div>
                    <div class="shadow-group" data-shadow="1"><img class="shadow-group__svg" data-asset="shadowPanels" src="<?php echo screenl_asset('hero/shadow-panels-joined.png'); ?>" alt=""></div>
                    <div class="shadow-group" data-shadow="2"><img class="shadow-group__svg" data-asset="shadowPanels" src="<?php echo screenl_asset('hero/shadow-panels-joined.png'); ?>" alt=""></div>
                    <div class="shadow-group" data-shadow="3"><img class="shadow-group__svg" data-asset="shadowPanels" src="<?php echo screenl_asset('hero/shadow-panels-joined.png'); ?>" alt=""></div>
                    <div class="shadow-group" data-shadow="4"><img class="shadow-group__svg" data-asset="shadowPanels" src="<?php echo screenl_asset('hero/shadow-panels-joined.png'); ?>" alt=""></div>
                    <div class="shadow-group" data-shadow="5"><img class="shadow-group__svg" data-asset="shadowPanels" src="<?php echo screenl_asset('hero/shadow-panels-joined.png'); ?>" alt=""></div>
                </div>
                <div class="bezels" id="bezels">
                    <div class="bezel bezel--left" data-bezel="0" data-role="side-left"><svg class="bezel__svg" viewBox="0 0 228 41" preserveAspectRatio="none" fill="none" aria-hidden="true"><path d="M0 0H228V41H0V0Z" fill="black" filter="url(#bezelShadow)"></path></svg><div class="bezel__clip"><img class="bezel__img" data-asset="bezel" src="<?php echo screenl_asset('hero/bezel-texture.png'); ?>" alt=""></div></div>
                    <div class="bezel bezel--center" data-bezel="1" data-role="center"><svg class="bezel__svg" viewBox="0 0 228 41" preserveAspectRatio="none" fill="none" aria-hidden="true"><path d="M0 0H228V41H0V0Z" fill="black" filter="url(#bezelShadow)"></path></svg><div class="bezel__clip"><img class="bezel__img" data-asset="bezel" src="<?php echo screenl_asset('hero/bezel-texture.png'); ?>" alt=""></div></div>
                    <div class="bezel bezel--center" data-bezel="2" data-role="center"><svg class="bezel__svg" viewBox="0 0 228 41" preserveAspectRatio="none" fill="none" aria-hidden="true"><path d="M0 0H228V41H0V0Z" fill="black" filter="url(#bezelShadow)"></path></svg><div class="bezel__clip"><img class="bezel__img" data-asset="bezel" src="<?php echo screenl_asset('hero/bezel-texture.png'); ?>" alt=""></div></div>
                    <div class="bezel bezel--center" data-bezel="3" data-role="center"><svg class="bezel__svg" viewBox="0 0 228 41" preserveAspectRatio="none" fill="none" aria-hidden="true"><path d="M0 0H228V41H0V0Z" fill="black" filter="url(#bezelShadow)"></path></svg><div class="bezel__clip"><img class="bezel__img" data-asset="bezel" src="<?php echo screenl_asset('hero/bezel-texture.png'); ?>" alt=""></div></div>
                    <div class="bezel bezel--center" data-bezel="4" data-role="center"><svg class="bezel__svg" viewBox="0 0 228 41" preserveAspectRatio="none" fill="none" aria-hidden="true"><path d="M0 0H228V41H0V0Z" fill="black" filter="url(#bezelShadow)"></path></svg><div class="bezel__clip"><img class="bezel__img" data-asset="bezel" src="<?php echo screenl_asset('hero/bezel-texture.png'); ?>" alt=""></div></div>
                    <div class="bezel bezel--right" data-bezel="5" data-role="side-right"><svg class="bezel__svg" viewBox="0 0 228 41" preserveAspectRatio="none" fill="none" aria-hidden="true"><path d="M0 0H228V41H0V0Z" fill="black" filter="url(#bezelShadow)"></path></svg><div class="bezel__clip"><img class="bezel__img" data-asset="bezel" src="<?php echo screenl_asset('hero/bezel-texture.png'); ?>" alt=""></div></div>
                </div>
            </div>
        </section>