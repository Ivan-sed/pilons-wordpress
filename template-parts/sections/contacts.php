...
?>
        ...
        <footer class="contacts" id="contacts">
            ...
            <div class="contacts__panel">
                ...
                <form class="contacts__form-area js-lead-form" novalidate>
                    <div class="contacts__fields">
                        <div class="contacts__field"><input class="contacts__input" type="text" name="name" placeholder="Имя" autocomplete="name" required></div>
                        <div class="contacts__field"><input class="contacts__input" type="text" name="contact" placeholder="Телефон / E-mail" autocomplete="tel" required></div>
                    </div>
                    <div class="contacts__messengers">
                        <p class="contacts__messenger-label">Где удобно связаться?</p>
                        <div class="contacts__messenger-options">
                            <label class="contacts__messenger-option"><input class="contacts__messenger-input" type="radio" name="messenger" value="Telegram"><span class="contacts__messenger-radio" aria-hidden="true"></span><span class="contacts__messenger-option-text">Telegram</span></label>
                            <label class="contacts__messenger-option"><input class="contacts__messenger-input" type="radio" name="messenger" value="MAX"><span class="contacts__messenger-radio" aria-hidden="true"></span><span class="contacts__messenger-option-text">МАХ</span></label>
                            <label class="contacts__messenger-option"><input class="contacts__messenger-input" type="radio" name="messenger" value="Телефон"><span class="contacts__messenger-radio" aria-hidden="true"></span><span class="contacts__messenger-option-text">Телефон</span></label>
                            <label class="contacts__messenger-option"><input class="contacts__messenger-input" type="radio" name="messenger" value="Почта"><span class="contacts__messenger-radio" aria-hidden="true"></span><span class="contacts__messenger-option-text">Почта</span></label>
                        </div>
                    </div>
                    <p class="contacts__error js-form-error" role="alert" aria-live="polite" hidden></p>
                    <button class="contacts__submit" type="submit">Получить расчёт</button>
                    <div class="contacts__success js-form-success" hidden>
                        <p class="contacts__success-title">Спасибо! Заявка отправлена</p>
                        <p class="contacts__success-text">Свяжемся с вами в течение 10 минут</p>
                    </div>
                </form>
                <div class="contacts__info">
                    ...
                    <nav class="contacts__nav">
                        <div class="contacts__nav-col">
                            <a class="contacts__nav-link" href="#benefits">Преимущества</a>
                            <a class="contacts__nav-link" href="#scenarios">Сценарии применения</a>
                            <a class="contacts__nav-link" href="#configs">Конфигурации</a>
                        </div>
                        <div class="contacts__nav-col">
                            <a class="contacts__nav-link" href="#">Кейсы</a>
                            <a class="contacts__nav-link" href="#faq">FAQ</a>
                            <a class="contacts__nav-link" href="#">Политика конфиденциальности</a>
                        </div>
                    </nav>
