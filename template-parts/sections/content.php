        ...
        <section class="content" id="content" aria-labelledby="content-title">
            ...
            <div class="content__text">
                ...
                <div class="content__ai-note">
                    ...
                    <p class="content__ai-text">Перед мероприятием проводим тестовый запуск контента — вы заранее видите, как всё будет выглядеть на пилонах, без сюрпризов в день мероприятия</p>
                </div>
            </div>
        </section>
